...
def code_der_in_datei_geschrieben_wird(liste=[],parameterliste=[],beschreibung=beschreibung,minwidth=1000,minhight=500):
    ...
    arbeits_fenster=PanedWindow(master)
    ...
    #arbeits_fenster
    root=PanedWindow(arbeits_fenster,handlesize=100,orient=VERTICAL)
    ...
    root.add(beschreibung_label,sticky="n")
    ...
    root.add(parameterliste_label,sticky="s",after=beschreibung_label)
